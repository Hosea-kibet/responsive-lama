...
const steps = [
  {
    label: "Play a song of your choice.",
    description: `Play any music from our endless playlist.`,
  },
  {
    label: "Enter you number and generate OTP.",
    description:
      "If you want  the currently playing song as you skiza tune,enter your number   and generate an OTP .",
  },
  {
    label: "Enter OTP.",
    description: "After generating an OTP enter it in the provided field.",
  },
  {
    label: "Subscribe to SKIZA tune",
    description: `Hit the subscribe button and  you have your favourite tune as your SKIZA.`,
  },
];
